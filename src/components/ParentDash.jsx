...
const ParentDash = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        const parsedUser = JSON.parse(storedUser); // Convert back to object
        console.log("User retrieved:", parsedUser); // Debugging
        ...
        <nav>
          <ul>
            <div className="board">
              ...
              <Link to="/ParentDashboard" className="link" >Dashboard</Link>
            </div>
            <div className="board">
              <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281723/home-2_wwzqrg.png" alt="" />
              <Link to="/ViewAddmission" className="link" >Addmission</Link>
            </div>
            <div className="board">
              <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281723/teacher_mmxcpi.svg" alt="" />
              <Link to="/ViewAttendance" className="link" >Attendance</Link>
            </div>
            <div className="board">
